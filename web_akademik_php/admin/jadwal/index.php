...
<div class="tabel-page">
    ...
    <div class="data-result">
        <div class="button-container">
            <button class="button-input" id="myBtn" onclick="showModal('modalAjar')">
        ...
        <table id="list-data" class="display">
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            <button class="button-edit" id="buttonEdit<?= $i ?>" onclick="show_modal_edit(<?php echo $i ?>)">
                    ...
                    <?php echo $row['ID_Ruangan'] ?>">
                                    ...
                                    <datalist id="ruangan">
                                        ...
                                        ?>
                                                <option value="<?php echo $row_r['ID_Ruangan'] ?>"><?php echo $row_r['Nama_Ruangan'] ?></option>
                                        <?php
                                            }
                                        }
                                        ?>
...
<!-- Modal Input Data -->
<div id="modalAjar" class="modal">
    <!-- Modal content -->
    <div class="modal-content">
        <div class="modal-header">
            <span class="close" id="close0" onclick="closeModal('modalAjar')">&times;</span>
        ...
        <div class="modal-body">
            <form name="input" method="post" action="jadwal/jadwal_mengajar_input.php">
                ...
                <datalist id="matkul">
                    ...
                    ?>
                        <option value="<?php echo $l_matkul['ID_Matkul'] ?>"> <?php echo $l_matkul['Nama_Matkul'] ?>
                        </option>
                    <?php
                    }
                    ?>
