...
?>
    <div class="tabel-page">
        ...
        <div class="button-container">
            <button class="button-input" id="myBtn" onclick="showModal('modalNilai')">
        ...
        <table id="list-data" class="display">
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            <a href='javascript:hapusDataNilai ("<?php echo $row['NIM'] ?>", "<?php echo $row['ID_Matkul'] ?>", 
                        "<?php echo $a_tingkat ?>")'>
...
<div id="modalNilai" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            <span class="close" id="close0" onclick="closeModal('modalNilai')">&times;</span>
